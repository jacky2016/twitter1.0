...
/**
 * 我的微博--@提到我的中的评论action类
 * 
 * @author shangwei
 */
public class TalkMeListCommentAction extends ActionBase {
	...
	public Object doAction() {
		...
		/**
		 * 我的微博--@提到我的的评论事件action
		 * 
		 * @author shangwei
		 */
		if (queryStr.equals("talkMeComment")) {
			// 是否同时评论微博
