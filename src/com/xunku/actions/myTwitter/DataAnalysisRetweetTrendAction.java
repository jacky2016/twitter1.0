...
import com.xunku.app.result.OfficialRetweetResult;
 ...
 * @author sunao
 */
public class DataAnalysisRetweetTrendAction extends ActionBase {
	...
	public LineDTO doAction() {
		...
		Map<Long, Integer> map = AppServerProxy.getViewRetweetTrend(uid,
