...
//                    }
            ...
            if (i.itemTemplate == false) {
              ...
              i.itemTemplate = '<div id="${fileID}" class="uploadify-queue-item"><div class="cancel"><a href="javascript:$(\'#${instanceID}\').uploadify(\'cancel\', \'${fileID}\')">X</a></div><span class="data"></span><div class="uploadify-progress"><div class="uploadify-progress-bar" style="display:none;"></div></div></div>';
            }
...
//                }
    ...
    c.fn.uploadify = function (d) {
        if (b[d]) {
             //add by shangw
             //if(this.prev()[FD]('uploadify-queue-item')[LN]<4 && this[AT]('id')=='uploadify2') this.css('visibility','visible');
